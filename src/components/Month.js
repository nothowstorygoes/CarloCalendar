...
export default function Month() {
  ...
  useEffect(() => {
    console.log("Filtered events in Month component:", filteredEvents);
  }, [filteredEvents]);

  return (
    <div className="mb-5 mr-5 flex-1 grid grid-cols-7 grid-rows-6 bg-white dark:bg-zinc-950 rounded-3xl">
